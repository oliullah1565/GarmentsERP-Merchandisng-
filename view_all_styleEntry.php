                        ...
                        <table class="table table-info">
                          ...
                          <tbody>
                            ...
                            <?php
                              ...
                              <td><div class='btn-group'><button class='btn btn-secondary btn-success '><a href='viewStyleentry.php?id=".$row['OID']."'>Report</a></button><button class='btn btn-warning btn-secondary'><a href='updateStyleentry.php?id=".$row['OID']."'>Edit</a></button><button class='btn btn-danger btn-secondary'><a href='deleteStyleentry.php?id=".$row['OID']."'>Delete</a></button></div></td>
                              </tr>
                              ";
