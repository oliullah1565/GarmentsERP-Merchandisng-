...
?>
            ...
            <div class="row">
                      ...
                      <div class="col-md-10">
                      <form action="PreOrderTwo.php" method="POST" enctype="multipart/form-data" >
                              <!--oder id-->
    ...
    <?php
     ...
     if(isset($_POST['order_submit']))
     {
      ...
      $show="SELECT styleentry.order_id as OID, styleentry.*,fabrication.*,print_embroidery.*,basic_accessories.*,decorative_accessories.*,finishing_accessories.* FROM styleentry left outer JOIN fabrication ON styleentry.order_id=fabrication.order_id left outer JOIN print_embroidery ON styleentry.order_id=print_embroidery.order_id left outer JOIN basic_accessories ON styleentry.order_id=basic_accessories.order_id left outer JOIN decorative_accessories ON styleentry.order_id=decorative_accessories.order_id left outer JOIN finishing_accessories ON styleentry.order_id=finishing_accessories.order_id where styleentry.order_id='$orderid'"; 
 ...
 <h4 style="text-align:center">Basic Accessories</h4>
  ...
  <table class="table table-bordered col-10">
             ...
             <hr>
                <form action="PreOrderTwoCode.php" method="post">
                ...
                <div class="form-row">
                    ...
                    <input type="text" class="form-control" id="totalWaste" name="totalWaste" required>
                  </div>
                    <div class="form-group col-md-4 ">
                  ...
                  <div class="form-group col-md-4 ">
                    ...
                    <input type="text" class="form-control" id="perHourproduction" name="perHourproduction" required>
                  </div>
                 </div>
                 <div class="form-row">
                 <div class="form-group col-md-6 ">
                    <label for="working_day" active><b>Working day/month:</b></label>
                    <input type="text" class="form-control" id="working_day" name="working_day" required>
                  </div>
                    <div class="form-group col-md-6 ">
                    <label for="required_machine" active><b>Total number of Machine required to complete an item:</b></label>
                    <input type="text" class="form-control" id="required_machine" name="required_machine" required>
                  </div>
                 </div>

                 <div class="form-row">
                <div class="col-md-4"></div>
                <input id="save_btn" type="submit" class="col-md-2 btn btn-success" value="Save Production order">
            </div>
