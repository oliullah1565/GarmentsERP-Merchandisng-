              ...
              <center>
                        ...
                        <table class="table table-info">
                          ...
                          <?php
                              ...
                              <td><div class='btn-group'><button class='btn btn-secondary btn-success '><a href='viewPreorder.php?id=".$row['OID']."'>Report</a></button><button class='btn btn-warning btn-secondary'><a href='updatePreorder.php?id=".$row['OID']."'>Edit</a></button><button class='btn btn-danger btn-secondary'><a href='deletePreorder.php?id=".$row['OID']."'>Delete</a></button></div></td>
                              </tr>
                              ";//}
                              //else{
                               // exit;
